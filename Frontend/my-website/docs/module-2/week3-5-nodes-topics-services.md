...
This lesson explores the core communication patterns in ROS 2: nodes, topics, services, and actions.
...
In the next lesson, we'll explore how to build ROS 2 packages with Python.